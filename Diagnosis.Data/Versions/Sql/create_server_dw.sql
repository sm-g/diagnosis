...
GO
ALTER TABLE [HrItem] ADD CONSTRAINT [FK_HrItem_Pat] FOREIGN KEY ([PatientID]) REFERENCES [Patient]([Id]) ON DELETE set null ON UPDATE no action;
GO
ALTER TABLE [HrItem] ADD CONSTRAINT [FK_HrItem_Course] FOREIGN KEY ([CourseID]) REFERENCES [Course]([Id]) ON DELETE no action ON UPDATE no action;
GO
ALTER TABLE [HrItem] ADD CONSTRAINT [FK_HrItem_App] FOREIGN KEY ([AppointmentID]) REFERENCES [Appointment]([Id]) ON DELETE set null ON UPDATE no action;
GO
ALTER TABLE [HrItem] ADD CONSTRAINT [FK_HrItem_Doc] FOREIGN KEY ([DoctorID]) REFERENCES [Doctor]([Id]) ON DELETE no action ON UPDATE no action;
GO
