...
Filename: "{tmp}\Synchronization-v2.1-x86-ENU.msi"; Parameters: "/quiet"; Flags: shellexec waituntilterminated; StatusMsg: "установка Sync Framework 2.1 Core..."; Check: not IsRequiredSyncFrDetected; AfterInstall: SetSyncCoreInstalled
Filename: "{tmp}\DatabaseProviders-v3.1-x86-ENU.msi"; Parameters: "/quiet"; Flags: shellexec; StatusMsg: "установка Sync Framework 2.1 DatabaseProviders..."; Check: IsNeedToInstallDatabaseProviders
